...
QueueHandle_t xQueue_data_LED_COM; //!< FreeRTOS queue to ask the led task to activate a specific led or a group of leds
                                   //!< (from an command that come from the mqtt brocker)
QueueHandle_t xQueue_data_Button_COM; //!< FreeRTOS queue to ask the communication task to send the value of the buttons
                                      //!< to the broker
QueueHandle_t xQueue_data_Potentimeter_COM; //!< FreeRTOS queue to ask the communication task to send the value of the
                                            //!< potentiometer to the broker
